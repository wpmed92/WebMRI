...
# installed.
TK_PREFIX='/usr/people/steve/TCLredhat7'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/usr/people/steve/TCLredhat7'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/usr/people/steve/TCLredhat7/lib -ltk8.4'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/usr/people/steve/TCLredhat7/lib -ltkstub8.4'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/usr/people/steve/src/packages/tcl/8.4.7.0/tk8.4.7/unix/libtkstub8.4.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/usr/people/steve/TCLredhat7/lib/libtkstub8.4.a'
