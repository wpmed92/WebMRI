...
# installed.
TCL_PREFIX='/usr/local/fsl'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/usr/local/fsl'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/Users/duncan/src/tcl8.4.7/unix -ltcl8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/usr/local/fsl/lib -ltcl8.4${TCL_DBGX}'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/usr/local/fsl/include'
...
# compiled.
TCL_SRC_DIR='/Users/duncan/src/tcl8.4.7'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/usr/local/fsl/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/Users/duncan/src/tcl8.4.7/unix -ltclstub8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/usr/local/fsl/lib -ltclstub8.4${TCL_DBGX}'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/Users/duncan/src/tcl8.4.7/unix/libtclstub8.4${TCL_DBGX}.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/usr/local/fsl/lib/libtclstub8.4${TCL_DBGX}.a'
