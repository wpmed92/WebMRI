...
# installed.
TCL_PREFIX='/usr/people/steve/TCLredhat9'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/usr/people/steve/TCLredhat9'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/usr/people/steve/TCLredhat9/lib -ltcl8.4${TCL_DBGX}'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/usr/people/steve/TCLredhat9/include'
...
TCL_PACKAGE_PATH='/usr/people/steve/TCLredhat9/lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/usr/people/steve/TCLredhat9/lib -ltclstub8.4${TCL_DBGX}'
...
TCL_STUB_LIB_PATH='/usr/people/steve/TCLredhat9/lib/libtclstub8.4${TCL_DBGX}.a'
