...
sprintf(filename,"%s %s_cov.ppm %s_cov.gif",getenv("FSLCONVERT"),argv[1],argv[1]);
system(filename);
...
sprintf(filename,"%s %s.ppm %s.gif",getenv("FSLCONVERT"),argv[1],argv[1]);
system(filename);
