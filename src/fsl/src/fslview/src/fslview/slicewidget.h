...
public:
  SagittalWidget(QWidget* parent, const char* name, 
    ...
    SliceWidget(parent, name, SliceWidget::Sagittal, c, l, d, u) 
    {};
...
public:
  CoronalWidget(QWidget* parent, const char* name, 
		Cursor::Handle c, OverlayList::Handle l, DrawSettings::Handle d,
		std::list<Shape::Handle>& u):
    SliceWidget(parent, name, SliceWidget::Coronal, c, l, d, u) 
    {};
  virtual void setImageCursor(int, int, int, int);  
  virtual void setZoom(int);
private:  
...
public:
  AxialWidget(QWidget* parent, const char* name, 
	      Cursor::Handle c, OverlayList::Handle l,  DrawSettings::Handle d,std::list<Shape::Handle>& u):
    SliceWidget(parent, name, SliceWidget::Axial, c, l, d, u) 
    {};
  virtual void setImageCursor(int, int, int, int);  
  virtual void setZoom(int);
private:
