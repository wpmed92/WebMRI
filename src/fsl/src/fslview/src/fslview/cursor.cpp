...
//! @param o the initial observer which for this cursor
//! @param xMax the extent of the cursor [0,xMax] in x
//! @param yMax the extent of the cursor [0,yMax] in y
//! @param zMax the extent of the cursor [0,zMax] in z
//! @param vMax the extent of the cursor [0,vMax] in volumes
...
Cursor::Handle Cursor::clone()
{
  ...
  return Handle(new Cursor(m_x, m_y, m_z, m_v,
