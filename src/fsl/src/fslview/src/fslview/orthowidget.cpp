...
OrthoWidget::OrthoWidget(QWidget *parent, ImageGroup::Handle& i,
  ...
  ImageWidget(parent, i, ol, c), m_image(i)
{
...
//   m_slices->push_back(m_coronal);
//   m_slices->push_back(m_sagittal);
//   m_slices->push_back(m_axial);
...
void OrthoWidget::setLabels(const OverlayList* o)
{
  ...
  if(i->hasValidXfms()) {
    ...
    m_sagittal->setLabelsState(SliceView::Greyed);
    m_coronal->setLabelsState(SliceView::Greyed);
    m_axial->setLabelsState(SliceView::Greyed);
  }
}
