 ...
 */
SplashScreen::SplashScreen(QWidget *parent, const OverlayOptionList& overlays, const char *name) 
  : QFrame(parent, name, QWidget::WStyle_NoBorder | QWidget::WStyle_Customize), m_overlays(overlays)
{
...
void SplashScreen::runApplication()
{
  ...
  ApplicationWindow *w = new ApplicationWindow(m_overlays);
