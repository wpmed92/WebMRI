...
but I'd like to work it into a GIF ! extension for XAnim playback.
...
---------------
Here's the relevant portion from xanim.doc
--------------
TXT files
  ...
  NOTE: txtmerge currently ignores frame information.
