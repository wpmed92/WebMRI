...
string title="tbss_skeleton (Version 1.0)\nCopyright(c) 2005-2006, University of Oxford (Stephen Smith)";
string examples="tbss_skeleton -i <inputimage> { -o <skeleton> | -p <skel_thresh> <distancemap> <search_rule_mask> <4Ddata> <projected_4Ddata> [-a <alt_4D>] }";
