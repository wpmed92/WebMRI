...
frame $w.f.g
tixControl $w.f.g.m1min -label "m1   Min" -variable flobsvars(m1min) -step 0.5 -min 0 -selectmode immediate -options { entry.width 4 }
grid $w.f.g.m1min -in $w.f.g -column 0 -row 0
tixControl $w.f.g.m1max -label "   Max" -variable flobsvars(m1max) -step 0.5 -min 0 -selectmode immediate -options { entry.width 4 }
grid $w.f.g.m1max -in $w.f.g -column 1 -row 0
tixControl $w.f.g.m2min -label "m2   Min" -variable flobsvars(m2min) -step 0.5 -min 0 -selectmode immediate -options { entry.width 4 }
grid $w.f.g.m2min -in $w.f.g -column 0 -row 1
tixControl $w.f.g.m2max -label "   Max" -variable flobsvars(m2max) -step 0.5 -min 0 -selectmode immediate -options { entry.width 4 }
grid $w.f.g.m2max -in $w.f.g -column 1 -row 1
tixControl $w.f.g.m3min -label "m3   Min" -variable flobsvars(m3min) -step 0.5 -min 0 -selectmode immediate -options { entry.width 4 }
grid $w.f.g.m3min -in $w.f.g -column 0 -row 2
tixControl $w.f.g.m3max -label "   Max" -variable flobsvars(m3max) -step 0.5 -min 0 -selectmode immediate -options { entry.width 4 }
grid $w.f.g.m3max -in $w.f.g -column 1 -row 2
tixControl $w.f.g.m4min -label "m4   Min" -variable flobsvars(m4min) -step 0.5 -min 0 -selectmode immediate -options { entry.width 4 }
grid $w.f.g.m4min -in $w.f.g -column 0 -row 3
tixControl $w.f.g.m4max -label "   Max" -variable flobsvars(m4max) -step 0.5 -min 0 -selectmode immediate -options { entry.width 4 }
grid $w.f.g.m4max -in $w.f.g -column 1 -row 3
tixControl $w.f.g.cmin -label "c     Min" -variable flobsvars(cmin) -step 0.1 -min 0 -selectmode immediate -options { entry.width 4 }
grid $w.f.g.cmin -in $w.f.g -column 0 -row 4
tixControl $w.f.g.cmax -label "   Max" -variable flobsvars(cmax) -step 0.1 -min 0 -selectmode immediate -options { entry.width 4 }
grid $w.f.g.cmax -in $w.f.g -column 1 -row 4

set flobsvars(nflobs) 3
tixControl $w.f.nflobs -label "Number of basis functions" -variable flobsvars(nflobs) -step 1 -min 1 -selectmode immediate -options { entry.width 4 }

FSLFileEntry $w.f.featdir \
