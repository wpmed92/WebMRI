...
#
#   Copyright (C) 2000-2003 University of Oxford
#
...
#
# usage: fsl:echo <filename> "string" [-n]
# -n : overwrite instead of appending
#
...
#
# usage: fsl:exec "the command" [-n] [-r]
# -n : don't output logging information
# -r : run on a remote machine
#
proc fsl:exec { thecommand args } {
    ...
    if { [ info exists FD ] } {
	fsl:echo ${FD}/.fslcurrent [ file tail [ lindex $thecommand 0 ] ] -n
    }
